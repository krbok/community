...
export const GET_USER_ROLE_ROUTE = `${AUTH_ROUTES}/role`;


export const PRACTICE_ZONE_ROUTES = {
  INITIALIZE: '/api/practice-zone/initialize',
  GET_PORTFOLIO: '/api/practice-zone/portfolio',
  BUY: '/api/practice-zone/buy',
  SELL: '/api/practice-zone/sell',
  STATS: '/api/practice-zone/stats'
};
